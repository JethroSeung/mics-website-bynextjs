...
export const siteConfig = {
  ...
  intro: {
    zh: "多模态智能通信与感知课题组隶属于南京邮电大学计算机学院，由左益平老师指导，围绕自然灾害场景下的痛感计算与医工交叉多模态感知开展研究。",
    en: "The MICS group is affiliated with the College of Computer Science, NJUPT, supervised by Dr. Zuo Yiping, focusing on pain computing in disaster scenarios and medical-engineering multimodal sensing.",
  },
  /** 首页"课题组介绍"区块（正式文案 §13-W2 后调整） */
  about: {
    lead: {
      zh: "面向自然灾害救援与健康监测场景，探索痛感计算与多模态感知融合技术。",
      en: "Exploring pain computing and multimodal sensing for disaster rescue and health monitoring.",
    },
    note: {
      zh: "多模态智能通信与感知课题组隶属于南京邮电大学计算机学院，由左益平老师指导。课题组围绕自然灾害场景下的痛感计算与医工交叉多模态感知开展研究，重视科研平台建设、跨学科合作与学生科研训练。",
      en: "The MICS group is affiliated with the School of Computer Science, Nanjing University of Posts and Telecommunications, supervised by Dr. Yiping Zuo. The group focuses on pain computing in natural disaster scenarios and medical-engineering multimodal sensing, with an emphasis on research platforms, interdisciplinary collaboration, and student research training.",
    },
  },
  ...
  heroSlides: [
    {
      ...
      tagline: {
        zh: "面向自然灾害救援与健康监测场景，开展痛感计算与医工交叉多模态感知研究。",
        en: "Research on pain computing in natural disaster scenarios and medical-engineering multimodal sensing.",
      },
      pills: [
        { zh: "痛感计算", en: "Pain Computing" },
    ...
    },
    {
      ...
      tagline: {
        zh: "聚焦自然灾害场景下的痛感计算与医工交叉多模态感知，扎实推进基础研究与场景落地。",
        en: "Pain computing in natural disaster scenarios and medical-engineering multimodal sensing.",
      },
      pills: [],
      actions: [
        { label: { zh: "了解痛感计算", en: "Pain Computing" }, href: "/research/pain", style: "primary" },
    ...
    },
    {
      ...
      tagline: {
        zh: "加入我们，探索痛感计算与多模态感知前沿，共筑科研梦想。",
        en: "Explore pain computing and multimodal sensing with us.",
      },
      pills: [
  ...
  nav: [
    ...
    {
      label: { zh: "痛感计算", en: "Pain Computing" },
      href: "/research/pain",
    },
    {
