    ...
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <button
          ...
          className="inline-flex size-10 items-center justify-center rounded-md text-body-secondary transition-colors hover:bg-surface hover:text-primary md:hidden focus-visible:outline-2 focus-visible:outline-ring"
        >
